...
ActiveRecord::Schema[7.1].define(version: 2025_07_28_103422) do
  ...
  create_table "abouts", force: :cascade do |t|
    ...
    t.string "adres"
    t.string "email"
    t.string "second_slogan"
    t.text "second_info"
    t.string "third_slogan"
  end
  ...
  create_table "profile_pages", force: :cascade do |t|
    ...
    t.string "slug"
    t.index ["slug"], name: "index_profile_pages_on_slug", unique: true
